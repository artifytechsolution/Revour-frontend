...
export default function NotFoundPage({
  ...
  homeUrl = "/",
  imageUrl = "https://undraw.co/api/illustrations/2e9f7e79-42bb-4a45-a470-672df47c90ec", // Example online SVG/PNG
}) {
  return (
    <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0 p-4">
      {/* Text Section */}
      ...
      <div className="w-full lg:w-1/2 lg:h-full flex lg:items-end justify-center">
        <img
          src={imageUrl}
